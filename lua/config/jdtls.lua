...
local function get_workspace()
    ...
    local workspace_path = home .. "/Programs/"
...
local function setup_jdtls()
    ...
    local settings = {
        java = {
            project = {
               referencedLibraries = vim.split(vim.fn.glob("~/projects/myproject/libs/*.jar"), "\n"),
               referencedLibraries = vim.fn.expand("build/classes/java/main/")
